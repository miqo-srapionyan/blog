                ...
                <div class="col-lg-8" style="margin:0 auto;">
                    <article class="blog_style1">
                        <div class="blog_img">
                            ...
                            echo ($post['image']) ? "/uploads/".$post['image'] : ''; ?>" alt="">
                        </div>
                        <div class="blog_text">
                            <div class="blog_text_inner">
                                <div class="cat">
                                    ...
                                    <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i> <?php
                                        echo date("F d, Y", strtotime($post['created_at'])); ?></a>
                                    <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> <?php
                                        echo $post['comment_count']; ?></a>
                                </div>
                                <a href="/blog/<?php
                                echo $post['id']; ?>"><h4><?php
                                        echo $post['title']; ?></h4></a>
                                <p><?php
                                    echo substr(strip_tags($post['description']), 0, 200); ?></p>
                                <a class="blog_btn" href="/blog/<?php
